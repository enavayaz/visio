...
def make_submission(predictions, submission_name="submission.csv"):
    ...
    save_path = os.path.join(save_dir, submission_name)
    submission.to_csv(save_path, index=False)
    print(f"File {submission_name} saved successfully in {save_dir}")
    return
